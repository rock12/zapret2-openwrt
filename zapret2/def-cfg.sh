...
function set_cfg_nfqws_strat
{
	...
	if [ "$strat" = "zm_alt" ]; then
		uci batch <<-EOF
			set $cfgname.config.MODE_FILTER='hostlist'
			set $cfgname.config.NFQWS2_PORTS_TCP='80,443,2053,2083,2087,2096,2802,2302,2502,3478-3480,3724,6000-8000,8085,8090,8100,8443,8903,8904,25565,27015-27030,27036-27037,35500-35600,50001,60442'
			set $cfgname.config.NFQWS2_PORTS_UDP='88,443,1024-2407,2409-4499,4502-19293,19345-49999,50000-65535'
			set $cfgname.config.NFQWS2_OPT="
				...
				--lua-desync=fake:blob=stun_fake:payload=~empty:repeats=6:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=6:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fakedsplit:pattern=0x00:payload=~empty:repeats=6:tcp_ts=-600000:tcp_ts_up
				--new
	...
	if [ "$strat" = "zm_alt2" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=multisplit:pos=2:seqovl=652:seqovl_pattern=tls_google:payload=~empty
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
	...
	if [ "$strat" = "zm_alt3" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--hostlist-domains=discord.media
				--payload=tls_client_hello
				--lua-desync=fake:blob=fake_default_tls:tls_mod=rnd,dupsid,sni=www.google.com:tcp_ts=-600000:tcp_ts_up
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n4 --payload=known,unknown
				--lua-desync=fake:blob=fake_default_tls:tls_mod=rnd,dupsid,sni=ya.ru:payload=~empty:tcp_ts=-600000:tcp_ts_up
				--lua-desync=hostfakesplit:host=ya.ru:payload=~empty:tcp_ts=-600000:tcp_ts_up
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n4 --payload=known,unknown
	...
	if [ "$strat" = "zm_alt4" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=fake:blob=stun_fake:payload=~empty:repeats=6:tcp_seq=1000:tcp_ack=-66000:tcp_ts_up
				--lua-desync=fake:blob=tls_google:payload=~empty:repeats=6:tcp_seq=1000:tcp_ack=-66000:tcp_ts_up
				--lua-desync=multisplit:payload=~empty
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n2 --payload=known,unknown
	...
	if [ "$strat" = "zm_alt5" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n4 --payload=known,unknown
				--lua-desync=syndata:payload=~empty
				--lua-desync=multidisorder:payload=~empty
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=fake:blob=game_udp:payload=~empty:repeats=14
			"
			commit $cfgname
		EOF
	fi
	if [ "$strat" = "zm_alt6" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=multisplit:pos=1:seqovl=681:seqovl_pattern=tls_google:payload=~empty
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n2 --payload=known,unknown
	...
	if [ "$strat" = "zm_alt8" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=fake:blob=fake_default_tls:payload=~empty:repeats=6:tcp_seq=2:tcp_ack=-66000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=6:tcp_seq=2:tcp_ack=-66000:tcp_ts_up
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n2 --payload=known,unknown
	...
	if [ "$strat" = "zm_alt9" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--hostlist-domains=discord.media
				--payload=tls_client_hello
				--lua-desync=hostfakesplit:host=www.google.com:repeats=4:tcp_ts=-600000:tcp_ts_up
				--new
				--filter-tcp=443 --filter-l7=tls
				--hostlist=/opt/zapret2/files/lists/google.list
				--payload=tls_client_hello
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=hostfakesplit:host=ozon.ru:payload=~empty:repeats=4:tcp_ts=-600000:tcp_ts_up
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n2 --payload=known,unknown
	...
	if [ "$strat" = "zm_alt10" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--out-range=<n3 --payload=known,unknown
				--lua-desync=fake:blob=stun_fake:payload=~empty:repeats=6:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_4pda:payload=~empty:repeats=6:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=6:tcp_ts=-600000:tcp_ts_up
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
	...
	if [ "$strat" = "zm_alt11" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--hostlist-domains=discord.media
				--payload=tls_client_hello
				--lua-desync=fake:blob=tls_google:repeats=8:tcp_ts=-600000:tcp_ts_up
				--lua-desync=multisplit:pos=1:seqovl=681:seqovl_pattern=tls_google
				--new
				--filter-tcp=443 --filter-l7=tls
				--hostlist=/opt/zapret2/files/lists/google.list
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n4 --payload=known,unknown
				--lua-desync=fake:blob=stun_fake:payload=~empty:repeats=8:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=8:tcp_ts=-600000:tcp_ts_up
	...
	if [ "$strat" = "zm_exp" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n4 --payload=known,unknown
				--lua-desync=fake:blob=stun2_fake:payload=~empty:repeats=8:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=8:tcp_ts=-600000:tcp_ts_up
				--lua-desync=multisplit:pos=1:seqovl=664:seqovl_pattern=tls_max:payload=~empty
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
	...
	if [ "$strat" = "zm_fake_tls_auto_alt" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=fake:blob=fake_default_tls:tls_mod=rnd,dupsid,sni=www.google.com:payload=~empty:repeats=8:tcp_seq=2:tcp_ack=-66000:tcp_ts_up
				--lua-desync=fakedsplit:pos=1:payload=~empty:repeats=8:tcp_seq=2:tcp_ack=-66000:tcp_ts_up
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n2 --payload=known,unknown
	...
	if [ "$strat" = "zm_fake_tls_auto_alt2" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=fake:blob=fake_default_tls:tls_mod=rnd,dupsid,sni=www.google.com:payload=~empty:repeats=8:tcp_seq=10000000:tcp_ack=-66000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=8:tcp_seq=10000000:tcp_ack=-66000:tcp_ts_up
				--lua-desync=multisplit:pos=1:seqovl=681:seqovl_pattern=tls_google:payload=~empty
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
	...
	if [ "$strat" = "zm_fake_tls_auto_alt3" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n4 --payload=known,unknown
				--lua-desync=fake:blob=fake_default_tls:tls_mod=rnd,dupsid,sni=www.google.com:payload=~empty:repeats=8:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=8:tcp_ts=-600000:tcp_ts_up
				--lua-desync=multisplit:pos=1:seqovl=681:seqovl_pattern=tls_google:payload=~empty
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
	...
	if [ "$strat" = "zm_simple_fake" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n4 --payload=known,unknown
				--lua-desync=fake:blob=tls_google:payload=tls_client_hello:repeats=6:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=http_req:repeats=6:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=stun_fake:payload=unknown:repeats=6:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_google:payload=unknown:repeats=6:tcp_ts=-600000:tcp_ts_up
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
	...
	if [ "$strat" = "zm_simple_fake_alt" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n3 --payload=known,unknown
				--lua-desync=fake:blob=stun_fake:payload=~empty:repeats=6:tcp_seq=2:tcp_ack=-66000:tcp_ts_up
				--lua-desync=fake:blob=tls_google:payload=~empty:repeats=6:tcp_seq=2:tcp_ack=-66000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=6:tcp_seq=2:tcp_ack=-66000:tcp_ts_up
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
	...
	if [ "$strat" = "zm_simple_fake_alt2" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--filter-tcp=1024-2052,2054-2082,2084-2086,2088-2095,2097-8442,8444-65535
				--ipset=/opt/zapret2/files/lists/ipset.list --ipset-exclude=/opt/zapret2/files/lists/ipset_exclude.list
				--out-range=<n5 --payload=known,unknown
				--lua-desync=fake:blob=stun_fake:payload=~empty:repeats=6:tcp_ts=-600000:tcp_ts_up
				--lua-desync=fake:blob=tls_max:payload=~empty:repeats=6:tcp_ts=-600000:tcp_ts_up
				--new
				--filter-udp=1024-19293,19345-49999,50101-65535
	...
	if [ "$strat" = "zm_martinbacker" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--new
				--ipset=/opt/zapret2/files/lists/ipset_do.list
				--filter-tcp=443 --filter-l7=tls
				--payload=tls_client_hello
				...
				--new
				--ipset=/opt/zapret2/files/lists/ipset_cf_full.list
				--filter-tcp=443 --filter-l7=tls
				--payload=tls_client_hello
				...
				--lua-desync=fake:blob=quic_initial:repeats=6
				--new
				--ipset=/opt/zapret2/files/lists/ipset_ovh.list
				--filter-tcp=443 --filter-l7=tls
				--payload=tls_client_hello
	...
	if [ "$strat" = "zm_hardcorp74" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--new
				--filter-tcp=443
				--hostlist=/opt/zapret2/files/lists/roblox.list
				--payload=tls_client_hello
				--lua-desync=hostfakesplit:host=www.google.com:midhost=host-4:altorder=0:badsum:md5sig:badseq:badseq_increment=0:ip_id=seqgroup:tcp_ts_up
				--new
				...
				--lua-desync=multisplit:pos=1,midsld:seqovl=568:seqovl_pattern=stun_fake:strategy=1
				--lua-desync=multisplit:pos=1,sniext+1:seqovl=582:seqovl_pattern=stun_fake:repeats=2-4:badsum:badseq:md5sig:strategy=1
				--lua-desync=fake:blob=tls_clienthello:tls_mod=rnd,dupsid,sni=www.google.com:tcp_ts=-1500:badsum:badseq:md5sig:tcp_md5:repeats=5:strategy=1
				--lua-desync=hostfakesplit:host=www.google.com:midhost=midsld-2:repeats=4:ip_ttl=2:strategy=1
				--lua-desync=fake:blob=tls_clienthello:tls_mod=rnd,dupsid,sni=ya.ru:tcp_seq=10000:strategy=2
				--lua-desync=multisplit:pos=1,midsld:seqovl=1:seqovl_pattern=tls_clienthello:tcp_ts_up:strategy=2
				--lua-desync=multidisorder:pos=1,sniext+1,host+1,midsld-2,midsld,midsld+2,endhost-1:strategy=3
				--lua-desync=fake:blob=tls_clienthello:optional:tcp_seq=-10000:tcp_ack=-66000:badsum:tls_mod=rnd,dupsid,sni=rzd.ru:repeats=4:strategy=3
				--payload=http_req
				--lua-desync=fake:blob=tls_sochi:repeats=5:tcp_ts=-600000:tcp_ts_up
				--lua-desync=hostfakesplit:host=mail.ru:tcp_ts=-600000:tcp_ts_up
				--filter-udp=443 --filter-l7=quic
				...
				--lua-desync=fake:blob=discord_udp:repeats=4:strategy=1
	...
	if [ "$strat" = "zm_eduncey" ]; then
		uci batch <<-EOF
			...
			set $cfgname.config.NFQWS2_OPT="
				...
				--lua-desync=hostfakesplit:host=ozon.ru:midhost=host-2:seqovl=sniext+3:seqovl_pattern=tls_clienthello:badsum:tcp_md5:tcp_ts_up:strategy=3
				--lua-desync=hostfakesplit:tcp_md5:tcp_ts_up:strategy=3
				--lua-desync=fake:blob=tls_clienthello:tls_mod=rnd,dupsid,sni=www.google.com:strategy=4
				...
				--out-range=<n2
				--payload=wireguard_initiation,wireguard_response,wireguard_cookie,mtproto_initial,unknown
				--lua-desync=circular:fails=2:time=300:retrans=3:nld=2
				--lua-desync=fake:repeats=6:strategy=1
				--lua-desync=fake:blob=quic_initial:repeats=6:strategy=2
				--new
